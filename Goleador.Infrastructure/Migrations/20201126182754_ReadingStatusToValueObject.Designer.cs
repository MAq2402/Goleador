...
namespace Goleador.Infrastructure.Migrations
{
    ...
    [Migration("20201126182754_ReadingStatusToValueObject")]
    partial class ReadingStatusToValueObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Goleador.Infrastructure.Auth.User", b =>
                {
            ...
            modelBuilder.Entity("Goleador.Domain.Book.Book", b =>
                {
                    b.OwnsOne("Goleador.Domain.Book.ReadingStatus", "Status", b1 =>
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Goleador.Infrastructure.Auth.User", null)
                        .WithMany()
